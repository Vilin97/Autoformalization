/-
  ...
  - grothendieck_vanishing_irreducible_pos: uses IrreduciblePosVanishing
    (3 sorry's: 1 in SheafHom.lean (AB5), 2 in FiniteGeneratorReduction.lean)
-/
...
3 sorry's remain (all reduce to AB5 for sheaves on Noetherian spaces):
  (1) isSheaf_filtered_colimit_of_sheaves (SheafHom.lean:64) — core AB5 gap,
  (2) recursive hQprov (FiniteGeneratorReduction.lean:146),
  (3) n=0 dead case (FiniteGeneratorReduction.lean:195).
