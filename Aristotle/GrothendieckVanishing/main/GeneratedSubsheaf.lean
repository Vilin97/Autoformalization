...
/-!
  ...
  - `TopCat.Sheaf.familyGeneratorMap`, `familyGeneratedSheaf`, `familyGeneratedSheafι`:
    the `zeroOutsideInt`-generated-by-a-family wrappers built from the generic API
  - `TopCat.Presheaf/Sheaf.finsetGeneratorMap`, `finsetGeneratedSheaf`:
  ...
  - `TopCat.Presheaf.SectionIndex` / `TopCat.Sheaf.SectionIndex`: generic indexing types
    for local sections
  - `TopCat.Presheaf.allSectionMap` / `TopCat.Sheaf.allSectionMap`: canonical coproduct maps
...
abbrev familyGeneratedSheaf {X : TopCat.{u}} {ι : Type*}
  ...
  familyImage (F := F) (fun i => zeroOutsideInt (U i))
    (fun i => zeroOutsideInt.sHom (s i))
...
abbrev familyGeneratedSheafι {X : TopCat.{u}} {ι : Type*}
  ...
  familyImageι (F := F) (fun i => zeroOutsideInt (U i))
    (fun i => zeroOutsideInt.sHom (s i))
