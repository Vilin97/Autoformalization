...
/-!
  # Core filtered-colimit infrastructure for presheaves

  This file contains the presheaf-level and sheaf-boundary infrastructure used to
  compare sheaf cohomology with filtered colimits on Noetherian spaces. It covers
  finite-cover gluing in filtered presheaf colimits, creation of filtered colimits
  by `sheafToPresheaf`, preservation of flasqueness, the successor-stage
  dimension-shift objects, and the degree-`0` presheaf-boundary comparison.
-/
