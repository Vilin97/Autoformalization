...
LEAN_TO_LABEL = {
    ...
    "pushforward_preserves_flasque": "lem:pushforward_preserves_flasque",
    ...
    "sheafH_dimension_shift_ses": "lem:sheafH_dimension_shift_ses",
    ...
    "constantSheaf_cohomology_vanishing": "cor:constantSheaf_cohomology_vanishing",
    ...
    "cokernel_openHom_vanishing": "thm:cokernel_openHom_vanishing",
    ...
    "sheafH_vanishing_cascade": "thm:sheafH_vanishing_cascade",
    "sheafH_vanishing_succ": "thm:sheafH_vanishing_succ",
...
TRANSITIVE_DEPS = {
    ...
    "pushforward_preserves_flasque": ["IsFlasqueSheaf"],
    ...
    "sheafH_dimension_shift_ses": ["ext_dimension_shift"],
    ...
    "constantSheaf_cohomology_vanishing": ["FlasqueVanishing", "constantSheaf_flasque_of_irreducible"],
    ...
    "zeroOutsideInt_vanishing": ["FlasqueVanishing", "IsFlasqueSheaf", "TopCat.Presheaf.zeroOutside", "TopCat.Sheaf.zeroOutsideInt", "constantSheaf_flasque_of_irreducible", "sheafH_dimension_shift_ses"],
    "cokernel_openHom_vanishing": ["PushforwardHVanishing", "TopCat.Presheaf.zeroOutside", "TopCat.Sheaf.zeroOutsideInt", "TopCat.closedIncl_counit_isIso", "epi_unit_of_closedImmersion", "topologicalKrullDim_lt_of_isIrreducible_of_isClosed"],
    ...
    "sheafH_vanishing_cascade": ["sheafH_vanishing_succ"],
    "sheafH_vanishing_succ": ["sheafH_dimension_shift_ses"],
