...
def blueprintDecls : Array Name := #[
  ...
  `constantSheaf_cohomology_vanishing,
  ...
  `ReducibleVanishing',
  `sheafH_vanishing_cascade,
  `sheafH_vanishing_succ,
